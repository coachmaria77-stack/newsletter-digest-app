// Newsletter Digest App - Frontend JavaScript                                                              
  ...
  available yet</h2><p>Generate a digest first.</p></div>';                                                   
                  loadButton.textContent = 'Refresh Digest';                                                  
                  loadButton.disabled = false;                                                                
              });                                                                                             
      }                                                                                                       
          ...
          fetch('/api/status')                                                                                
              ...
              .then(function(data) {                                                                          
                  if (data.last_run && data.last_run.timestamp) {                                             
                      var currentTimestamp = document.querySelector('.status-item .value');                   
                      if (currentTimestamp && currentTimestamp.textContent !== data.last_run.timestamp) {     
                          loadDigest();                                                                       
                      }                                                                                       
                  }                                                                                           
              })                                                                                              
